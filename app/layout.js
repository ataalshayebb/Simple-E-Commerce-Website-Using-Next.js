...
//                 <Link className="text-white hover:bg-white hover:bg-opacity-20 px-3 py-2 rounded-md" href="/login">Login</Link>
...
import LogoutButton from './LogoutButton'; // We'll create this component
            ...
            <div className="flex items-center justify-between h-16">
              ...
              <div className="hidden md:block">
                <div className="ml-10 flex items-baseline space-x-4">
                  ...
                  <Link className="text-white hover:bg-white hover:bg-opacity-20 px-3 py-2 rounded-md" href="/AllProducts">All Products</Link>
                  <Link className="text-white hover:bg-white hover:bg-opacity-20 px-3 py-2 rounded-md" href="/AllPosts">All Posts</Link>
                  {!token && <Link className="text-white hover:bg-white hover:bg-opacity-20 px-3 py-2 rounded-md" href="/login">Login</Link>}
                  {token && <LogoutButton />}
                </div>
              </div>
              <div className="flex items-center">
